...
class TestConnectionPoolURLParsing(object):
    ...
    def test_client_creates_connection_pool(self):
        r = redis_namespace.Redis.from_url('redis://myhost')
...
class TestConnection(object):
    def test_on_connect_error(self):
        ...
        # 9999 databases ;)
        bad_connection = redis_namespace.Redis(db=9999)
    ...
    def test_connect_from_url_tcp(self):
        connection = redis_namespace.Redis.from_url('redis://localhost')
    ...
    def test_connect_from_url_unix(self):
        connection = redis_namespace.Redis.from_url('unix:///path/to/socket')
        pool = connection.connection_pool
